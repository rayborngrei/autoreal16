...
const Field = ({
  ...
  <label className="block">
    <span className="mb-1 flex items-baseline gap-1 text-[11px] font-bold uppercase tracking-[0.12em] text-ink-3">
      ...
      {hint && <span className="ml-auto normal-case tracking-normal font-medium text-ink-3/60">{hint}</span>}
    </span>
    {children}
    {error && (
          ...
          <div className="border-b-2 border-ink bg-[#f2f4f6] md:border-b-0 md:border-r-2">
            <div className="p-5">
              ...
              <div className="mt-3 rounded-[4px] border-2 border-ink/15 bg-white p-3">
                ...
                <p className={`min-h-[54px] max-h-[110px] overflow-y-auto text-[13px] leading-snug ${transcript ? "text-ink" : "italic text-ink-3/50"}`}>
                  {transcript || EXAMPLE}
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-3.5">
              ...
              <Field label="Пробег" hint="км">
                <input inputMode="numeric" className={inputCls()} placeholder="45 000"
